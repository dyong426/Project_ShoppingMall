	...
	<div class="container">
		<div id="footer_logo" class="d-flex align-items-start">
			<a href="/" class="mb-3 me-2 mb-md-0 text-muted text-decoration-none">
				<img width=230px src="${contextPath}/assets/common/cstm_img/logo_white.png" alt="" />
			</a>
...
<script type="text/javascript" src="${contextPath}/assets/user/home/js/home.js"></script>
<script type="text/javascript" src="${contextPath}/assets/user/common/js/account_validation_check.js"></script>
<script type="text/javascript" src="${contextPath}/assets/user/common/js/login.js"></script>
