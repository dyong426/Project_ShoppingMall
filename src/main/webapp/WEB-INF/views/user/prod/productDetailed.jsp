...
<link rel="stylesheet" href="assets/user/prod/css/customizing.css">
			...
			<div id="settingPanelOuter">
				<div id="textSettingPanel" class="settingPanel">
					...
					<div id="fontFamily">
						...
						<select class="round_border" id="fontFamilyComboBox" onchange="changeFontFamily()">
						</select>
					</div>
					<div id="textAlignFontSize">
						<div id="textAlign" class="round_border">
							<span class="material-symbols-outlined">format_align_left</span> <span
								class="material-symbols-outlined">format_align_center</span> <span
								class="material-symbols-outlined">format_align_right</span>
						</div>
...
<script src="assets/user/prod/js/customizing.js"></script>
