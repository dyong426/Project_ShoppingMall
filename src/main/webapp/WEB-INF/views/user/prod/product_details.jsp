...
<%@ include file="../common/header.jsp"%>
    ...
    <div id="main_container">
        <!--canvas-->
        <div id="main_canvas_container"><span>canvas by 이동용</span></div>
            ...
            <div class="tg_body">
                <div class="print_area">
                    ...
                    <ul class="list1">
                        ...
                        <li>
                            인쇄를 원하시는 위치가 있을 시 [상품 제작 요청사항]에 남겨주시거나, 1:1 게시판 상담 또는
                            고객센터(031-555-4449)로 전화 주세요.
                        </li>
                    ...
                    <h2>교환/환불 불가 사항</h2>
                    <p class="txt1">
                        모든 상품은 고객 주문에 따라 개별 제작되는 방식으로 단순 변심을 포함, 아래의 경우에는 교환 /
                        환불이 불가합니다.
                    </p>
                    <h3>- 디자인 시안 색상의 차이</h3>
                    <p class="txt2">
                    ...
                    <p class="txt1">
                        ...
                        <a href="mailto:help@marpple.com">ezen@guri.academy</a> 또는 고객센터로 연락주셔야 가능합니다.
                    </p>
                    <p class="txt1">
                        ★ 주문 완료 후 상품 및 이미지 변경을 원하실 경우 [제작준비중] 상태에서만 변경이 가능하며 [제작중]에는
                        변경 및 취소가 불가합니다. 변경을 원하시는 경우 1:1 게시판 상담 및 고객센터(<a href="tel:031-555-4449">031-555-4449</a>)를 통해
                        문의 바랍니다.
                    </p>
                </div>
            </div>
    ...
    <div id="main_review_container">
        ...
        <!--사진 모아보기 (8개까지만)-->
        <div>
            <img src="assets/common/cstm_img/착샷.jpg" alt="">
            <img src="assets/common/cstm_img/착샷2.jpg" alt="">
            <img src="assets/common/cstm_img/착샷3.jpg" alt="">
            <img src="assets/common/cstm_img/착샷4.jpg" alt="">
            <img src="assets/common/cstm_img/예시1.jpg" alt="">
            <img src="assets/common/cstm_img/의류1.jpg" alt="">
            <img src="assets/common/cstm_img/의류2.jpg" alt="">
            <img src="assets/common/cstm_img/예시5.jpg" alt="">
        </div>
    </div>
            ...
            <div id="review_container">
                <div id="customer_review_text_container">
                    <div id="customer_review_stars_container">
                        <span id="customer_review_stars">★★★☆☆</span>
                        <span id="customer_review_stars_text">3</span>
                        <span id="customer_review_date">02.13</span>
                    </div>
                    <div id="customer_review_contents">
                        따뜻하네요 근데 좀 비싼 거 같아요<br>
                        <b>아래 사진 클릭하면 크게 보이게 하기</b>
                    </div>
                    <div>
                        <img src="assets/common/cstm_img/예시5.jpg" alt="" />
                        <img src="assets/common/cstm_img/예시2.jpg" alt="" />
                        <img src="assets/common/cstm_img/예시3.jpg" alt="" />
                    </div>
        ...
        <div id="customer_each_review_container">
            ...
            <div id="review_container">
                <div id="customer_review_text_container">
                    <div id="customer_review_stars_container">
                        <span id="customer_review_stars">★★★★★</span>
                        <span id="customer_review_stars_text">5</span>
                        <span id="customer_review_date">02.13</span>
                    </div>
                    <div id="customer_review_contents">
                        사랑스러워 넌 나의 애기야<br>
                        너무 귀여워 넌 나의 애기야<br>
                        정말 요리보고 조리봐도 어쩜 넌<br>
                        깨물고만 싶어 꼬집고만 싶어<br>
                        넌 나만의 Baby 영원한 나만의 자기<br>
        ...
        <div id="customer_each_review_container">
            ...
            <div id="review_container">
                <div id="customer_review_text_container">
                    <div id="customer_review_stars_container">
                        <span id="customer_review_stars">★☆☆☆☆</span>
                        <span id="customer_review_stars_text">1</span>
                        <span id="customer_review_date">02.13</span>
                    </div>
                    <div id="customer_review_contents">
                        지은아 리뷰 예시로 들 거 좀 말해줘. 좋아요~ 아니 길게 좀 말해봐 아니 그냥 가나다마바사해;;
                    </div>
                    <div>
                        <img src="assets/common/cstm_img/의류1.jpg" alt="" />
                        <img src="assets/common/cstm_img/의류2.jpg" alt="" />
                        <img src="assets/common/cstm_img/의류3.jpg" alt="" />
                    </div>
            ...
            <div id="review_container">
                <div id="customer_review_text_container">
                    <div id="customer_review_stars_container">
                        <span id="customer_review_stars">★☆☆☆☆</span>
                        <span id="customer_review_stars_text">1</span>
                        <span id="customer_review_date">12.14</span>
                    </div>
                    <div id="customer_review_contents">
                        옷 좋아요
                    </div>
