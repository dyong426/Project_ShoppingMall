...
<body>
			...
			<div class="card grid-main">
				...
				<form class="row card-body" id="prod-reg-form">
					...
					<div class="col-md-6">
						...
						<input type="text" class="form-control" id="p_name" placeholder="제품명을 입력하세요">
					</div>
					<div class="col-md-6">
						<label for="p_price" class="form-label">가격</label> 
						<input type="text" class="form-control" id="p_price" placeholder="가격을 입력하세요">
					</div>
					<div class="col-md-12">
						<label for="p_info_img_path" class="form-label">제품 정보 이미지</label>
						<input type="file" class="form-control" id="p_info_img_path" multiple>
					</div>
    ...
    <div class="background_url">
        <div class="body" style="background: url() no-repeat center center; background-size: cover; height: 0px;"></div>
    </div>
</div>
<div class="design_collection_contents">
    <div class="design_collection_content" design_collection_content_id="7064"
        _sel="./_->design_collection_contents->(#7064)" type="full_img" style="margin-bottom: 42.857142857142854px;">
        <div class="body">
            <div class="wrapper">
                <div class="thumbnail_url">
                    <div class="body"><img
                            src="/jhc/assets/admin/images/admin.png"></img>
                    </div>
                </div>
            </div>
        </div>
    </div>
    <div class="design_collection_content" design_collection_content_id="4154"
        _sel="./_->design_collection_contents->(#4154)" type="h1" style="margin-bottom: 17.142857142857142px;">
        <div class="body val" style="color:#000000;">실패 없는 커스텀 웨어</div>
    </div>
    <div class="design_collection_content" design_collection_content_id="4155"
        _sel="./_->design_collection_contents->(#4155)" type="p1" style="margin-bottom: 42.857142857142854px;">
        <div class="body val" style="color:#000000;">남녀노소 누구나 만족하는 후드 집업<br>나만의 디자인으로 특별함을 더해보세요.</div>
    </div>
    <div class="design_collection_content" design_collection_content_id="4156"
        _sel="./_->design_collection_contents->(#4156)" type="full_img" style="margin-bottom: 8.571428571428571px;">
        <div class="body">
            <div class="wrapper">
                <div class="thumbnail_url">
                    <div class="body"><img
    ...
    <div class="design_collection_content" design_collection_content_id="4318"
        _sel="./_->design_collection_contents->(#4318)" type="full_img" style="margin-bottom: 128.57142857142858px;">
        <div class="body">
            <div class="wrapper">
                <div class="thumbnail_url">
                    <div class="body"><img
    ...
    <div class="design_collection_content" design_collection_content_id="6123"
        _sel="./_->design_collection_contents->(#6123)" type="h1" style="margin-bottom: 17.142857142857142px;">
        <div class="body val" style="color:#000000;">5장부터 단체 할인이 적용돼요.</div>
    </div>
    <div class="design_collection_content" design_collection_content_id="6124"
        _sel="./_->design_collection_contents->(#6124)" type="p1" style="margin-bottom: 42.857142857142854px;">
        <div class="body val" style="color:#000000;">마플은 단 1장도 가능하지만<br>단체 구매는 할인 혜택이 있어요.<br>장바구니 담기 후 수량별 할인을 확인하세요.
        </div>
    </div>
    <div class="design_collection_content" design_collection_content_id="6125"
        _sel="./_->design_collection_contents->(#6125)" type="full_img" style="margin-bottom: 128.57142857142858px;">
        <div class="body">
            <div class="wrapper">
                <div class="thumbnail_url">
                    <div class="body"><img
    ...
    <div class="design_collection_content" design_collection_content_id="4277"
        _sel="./_->design_collection_contents->(#4277)" type="h1" style="margin-bottom: 17.142857142857142px;">
        <div class="body val" style="color:#000000;">ABOUT BRAND</div>
    </div>
    <div class="design_collection_content" design_collection_content_id="6038"
        _sel="./_->design_collection_contents->(#6038)" type="full_img" style="margin-bottom: 34.285714285714285px;">
        <div class="body">
            <div class="wrapper">
                <div class="thumbnail_url">
                    <div class="body"><img
    ...
    <div class="design_collection_content" design_collection_content_id="4278"
        _sel="./_->design_collection_contents->(#4278)" type="p1" style="margin-bottom: 42.857142857142854px;">
    ...
    <div class="design_collection_content" design_collection_content_id="4279"
        _sel="./_->design_collection_contents->(#4279)" type="full_img" style="margin-bottom: 128.57142857142858px;">
        <div class="body">
            <div class="wrapper">
                <div class="thumbnail_url">
                    <div class="body"><img
    ...
    <div class="design_collection_content" design_collection_content_id="4157"
        _sel="./_->design_collection_contents->(#4157)" type="h1" style="margin-bottom: 17.142857142857142px;">
        <div class="body val" style="color:#000000;">나만의 애착 후드 집업</div>
    </div>
    <div class="design_collection_content" design_collection_content_id="4158"
        _sel="./_->design_collection_contents->(#4158)" type="p1" style="margin-bottom: 42.857142857142854px;">
        <div class="body val" style="color:#000000;">반려동물, 나의 최애, 좋아하는 사진이나 그림,<br>무엇이든 가능해요.<br>입고 있는 순간, 매일이 행복할거에요.
        </div>
    </div>
    <div class="design_collection_content" design_collection_content_id="4159"
        _sel="./_->design_collection_contents->(#4159)" type="full_img" style="margin-bottom: 128.57142857142858px;">
        <div class="body">
            <div class="wrapper">
                <div class="thumbnail_url">
                    <div class="body"><img
    ...
    <div class="design_collection_content" design_collection_content_id="4160"
        _sel="./_->design_collection_contents->(#4160)" type="h1" style="margin-bottom: 17.142857142857142px;">
        <div class="body val" style="color:#000000;">소속감, 단결, 팀웍</div>
    </div>
    <div class="design_collection_content" design_collection_content_id="4161"
        _sel="./_->design_collection_contents->(#4161)" type="p1" style="margin-bottom: 42.857142857142854px;">
        <div class="body val" style="color:#000000;">우리를 상징하는 로고, 슬로건으로<br>단체 유니폼을 제작해보세요.<br>팀웍은 물론이고 구성원의 전문성이 더
            돋보일거에요.</div>
    </div>
    <div class="design_collection_content" design_collection_content_id="4162"
        _sel="./_->design_collection_contents->(#4162)" type="full_img" style="margin-bottom: 128.57142857142858px;">
        <div class="body">
            <div class="wrapper">
                <div class="thumbnail_url">
                    <div class="body"><img
    ...
    <div class="design_collection_content" design_collection_content_id="4163"
        _sel="./_->design_collection_contents->(#4163)" type="h1" style="margin-bottom: 17.142857142857142px;">
        <div class="body val" style="color:#000000;">소중한 기념일을 더 특별하게</div>
    </div>
    <div class="design_collection_content" design_collection_content_id="4164"
        _sel="./_->design_collection_contents->(#4164)" type="p1" style="margin-bottom: 42.857142857142854px;">
        <div class="body val" style="color:#000000;">가족, 커플, 친구와의 여행을 계획한다면<br>우리만의 커스텀 웨어로 특별한 추억을 선물하세요.</div>
    </div>
    <div class="design_collection_content" design_collection_content_id="4165"
        _sel="./_->design_collection_contents->(#4165)" type="full_img" style="margin-bottom: 128.57142857142858px;">
        <div class="body">
            <div class="wrapper">
                <div class="thumbnail_url">
                    <div class="body"><img
    ...
    <div class="design_collection_content" design_collection_content_id="4169"
        _sel="./_->design_collection_contents->(#4169)" type="h1" style="margin-bottom: 17.142857142857142px;">
        <div class="body val" style="color:#000000;">사진 후기만 무려 9만 개</div>
    </div>
    <div class="design_collection_content" design_collection_content_id="4170"
        _sel="./_->design_collection_contents->(#4170)" type="p1" style="margin-bottom: 42.857142857142854px;">
        <div class="body val" style="color:#000000;">마플만의 독보적인 인쇄 퀄리티는 이미 검증되었어요.<br />너, 나, 우리를 표현할 아이디어만 준비하세요.</div>
    </div>
    <div class="design_collection_content" design_collection_content_id="4171"
        _sel="./_->design_collection_contents->(#4171)" type="full_img" style="margin-bottom: 128.57142857142858px;">
        <div class="body">
            <div class="wrapper">
                <div class="thumbnail_url">
                    <div class="body"><img
    ...
    <div class="design_collection_content" design_collection_content_id="4172"
        _sel="./_->design_collection_contents->(#4172)" type="h1" style="margin-bottom: 17.142857142857142px;">
        <div class="body val" style="color:#000000;">타협 없는 품질에 대한 자부심</div>
    </div>
    <div class="design_collection_content" design_collection_content_id="4173"
        _sel="./_->design_collection_contents->(#4173)" type="p1" style="margin-bottom: 42.857142857142854px;">
    ...
    <div class="design_collection_content" design_collection_content_id="4174"
        _sel="./_->design_collection_contents->(#4174)" type="full_img" style="margin-bottom: 8.571428571428571px;">
        <div class="body">
            <div class="wrapper">
                <div class="thumbnail_url">
                    <div class="body"><img
    ...
    <div class="design_collection_content" design_collection_content_id="4175"
        _sel="./_->design_collection_contents->(#4175)" type="full_img" style="margin-bottom: 128.57142857142858px;">
        <div class="body">
            <div class="wrapper">
                <div class="thumbnail_url">
                    <div class="body"><img
    ...
    <div class="design_collection_content" design_collection_content_id="4176"
        _sel="./_->design_collection_contents->(#4176)" type="h1" style="margin-bottom: 42.857142857142854px;">
        <div class="body val" style="color:#000000;">후드 집업과 함께 보면 좋은 상품</div>
    </div>
    <div class="design_collection_content" design_collection_content_id="4177"
        _sel="./_->design_collection_contents->(#4177)" type="items" style="margin-bottom: 0px;">
        <div class="body">
            <div class="wrapper">
                <div class="design_collection_content_items" lines="1">
                    <div class="design_collection_content_item"
                        _sel="./_->design_collection_content_items->(#5089)""><div class=" wrapper"><a
                            href="/product/detail?bp_id=4673&pc_id=11276216" class="img_wrapper"><img
                ...
                <div class="design_collection_content_item"
                    _sel="./_->design_collection_content_items->(#5090)""><div class=" wrapper"><a
                        href="/product/detail?bp_id=3125&pc_id=11276217" class="img_wrapper"><img
            ...
            <div class="design_collection_content_item"
                _sel="./_->design_collection_content_items->(#5091)""><div class=" wrapper"><a
                    href="/product/detail?bp_id=4663&pc_id=11276218" class="img_wrapper"><img
        ...
        <div class="design_collection_content_item" _sel="./_->design_collection_content_items->(#5092)""><div class="
            wrapper"><a href="/product/detail?bp_id=4112&pc_id=11276219" class="img_wrapper"><img
...
<div class="product_detail_tab_body" data-tab_name="BP_DETAIL_TAB" data-is_hidden="false">
