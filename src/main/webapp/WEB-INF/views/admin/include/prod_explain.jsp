...
<div class="design_collection_contents">
	...
	<div class="design_collection_content"
		...
		style="margin-bottom: 42.857142857142854px;">
		<div class="body val" style="color: #000000;">
			남녀노소 누구나 만족하는 후드 집업<br>나만의 디자인으로 특별함을 더해보세요.
		</div>
	</div>
	<div class="design_collection_content"
	...
	<div class="design_collection_content"
		...
		style="margin-bottom: 42.857142857142854px;">
		<div class="body val" style="color: #000000;">
			마플은 단 1장도 가능하지만<br>단체 구매는 할인 혜택이 있어요.<br>장바구니 담기 후 수량별 할인을
			확인하세요.
		</div>
	</div>
	<div class="design_collection_content"
	...
	<div class="design_collection_content"
		...
		style="margin-bottom: 42.857142857142854px;">
		<div class="body val" style="color: #000000;">
			아시아 NO.1 무지 티셔츠 브랜드<br>프린트스타 & 글리머는 동양인 체형에 최적화된<br>핏과 스타일을
			제안합니다.<br>뛰어난 품질을 합리적인 가격으로 만나보세요.<br>*젤란은 프린트스타로 통합되었습니다.
		</div>
	</div>
	<div class="design_collection_content"
	...
	<div class="design_collection_content"
		...
		style="margin-bottom: 42.857142857142854px;">
		<div class="body val" style="color: #000000;">
			반려동물, 나의 최애, 좋아하는 사진이나 그림,<br>무엇이든 가능해요.<br>입고 있는 순간, 매일이
			행복할거에요.
		</div>
	</div>
	<div class="design_collection_content"
	...
	<div class="design_collection_content"
		...
		style="margin-bottom: 42.857142857142854px;">
		<div class="body val" style="color: #000000;">
			우리를 상징하는 로고, 슬로건으로<br>단체 유니폼을 제작해보세요.<br>팀웍은 물론이고 구성원의 전문성이
			더 돋보일거에요.
		</div>
	</div>
	<div class="design_collection_content"
	...
	<div class="design_collection_content"
		...
		style="margin-bottom: 42.857142857142854px;">
		<div class="body val" style="color: #000000;">
			가족, 커플, 친구와의 여행을 계획한다면<br>우리만의 커스텀 웨어로 특별한 추억을 선물하세요.
		</div>
	</div>
	<div class="design_collection_content"
	...
	<div class="design_collection_content"
		...
		style="margin-bottom: 42.857142857142854px;">
		<div class="body val" style="color: #000000;">
			마플만의 독보적인 인쇄 퀄리티는 이미 검증되었어요.<br />너, 나, 우리를 표현할 아이디어만 준비하세요.
		</div>
	</div>
	<div class="design_collection_content"
	...
	<div class="design_collection_content"
		...
		style="margin-bottom: 42.857142857142854px;">
		<div class="body val" style="color: #000000;">
			마플은 디지털 프린팅, 실크 스크린, 플렉스, 전사, 자수 등<br>각 의류 특성에 적합한 풍부한 인쇄 방식을
			제공합니다.<br>업계 최고의 기술력을 갖춘 전문가에게 맡기세요.
		</div>
	</div>
	<div class="design_collection_content"
