...
public interface OrderMapper {
	...
	public List<OrderDTO> selectOrderHistorySelectedAll(@Param("mem_num") Integer mem_num, @Param("ord_status")String ord_status, @Param("start_date")String start_date, @Param("end_date")String end_date);
